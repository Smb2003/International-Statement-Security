...
import { useState, useEffect } from "react"
import Particles from './../../utils/Particles'
import bgImage from "@/assets/222.png";
interface Location {
  id: number
  city: string
  country: string
...
const locations: Location[] = [
  { id: 1, city: "QATAR",     country: "DOHA",           service: "Executive Protection & VIP Security",  tag: "MIDDLE EAST", image: "https://images.unsplash.com/photo-1566288623394-377af472d81b?auto=format&fit=crop&w=900&q=80" },
  { id: 2, city: "DUBAI",     country: "UAE",             service: "High-Net-Worth Protection Unit",       tag: "GULF REGION", image: "https://images.unsplash.com/photo-1526495124232-a04e1849168c?auto=format&fit=crop&w=900&q=80" },
  { id: 3, city: "ABU DHABI", country: "UAE",             service: "Government & VIP Security",            tag: "GULF REGION", image: "https://images.unsplash.com/photo-1580674285054-bed31e145f59?auto=format&fit=crop&w=900&q=80" },
  { id: 4, city: "LONDON",    country: "UNITED KINGDOM",  service: "Executive & Diplomatic Protection",   tag: "EUROPE",      image: "https://images.unsplash.com/photo-1486299267070-83823f5448dd?auto=format&fit=crop&w=900&q=80" },
  { id: 5, city: "NEW YORK",  country: "UNITED STATES",   service: "Corporate Executive Security",        tag: "AMERICAS",    image: "https://images.unsplash.com/photo-1518391846015-55a9cc003b25?auto=format&fit=crop&w=900&q=80" },
  { id: 6, city: "ALBANIA",   country: "EUROPE",          service: "Strategic Security Operations",       tag: "BALKANS",     image: "https://images.unsplash.com/photo-1570125909232-eb263c188f7e?auto=format&fit=crop&w=900&q=80" },
  { id: 6, city: "ROME",   country: "ITALY",          service: "Strategic Security Operations",       tag: "BALKANS",     image: "https://images.unsplash.com/photo-1570125909232-eb263c188f7e?auto=format&fit=crop&w=900&q=80" },
]
    ...
    <div style={{ 
      ...
      <style>{`
        ...
        @keyframes borderBlink {
          0%,49%  { border-color:rgba(30,150,255,0.7); box-shadow:0 0 16px rgba(30,150,255,0.22),inset 0 0 12px rgba(30,150,255,0.06); }
          50%,99% { border-color:rgba(30,150,255,0.07); box-shadow:none; }
        }
        @keyframes barPulse {
          0%,49%  { opacity:1; }
          50%,99% { opacity:0; }
        ...
        .loc-card {
          ...
          border:1px solid rgba(30,150,255,0.7);
          background: rgba(8, 35, 75, 0.45) !important;
        ...
        .loc-card:hover {
          ...
          background:rgba(21, 52, 100, 0.43) !important;
        }
        .loc-card.is-active {
          border-color:rgba(30,160,255,0.65) !important;
          background:rgba(8,35,75,0.9) !important;
          box-shadow:0 0 22px rgba(30,150,255,0.2),inset 0 0 14px rgba(30,150,255,0.06);
        ...
        .loc-card .top-line {
          ...
          background:linear-gradient(to right,#1e96ff,transparent);
          opacity:0; transition:opacity 0.2s;
        }
        .loc-card:hover .top-line,
        .loc-card.is-active .top-line { opacity:1; }
        .loc-card::before,.loc-card::after {
          content:''; position:absolute; width:11px; height:11px; opacity:0; transition:opacity 0.2s;
        }
        .loc-card::before { top:0; right:0; border-top:1.5px solid #1e96ff; border-right:1.5px solid #1e96ff; }
        .loc-card::after  { bottom:0; left:0; border-bottom:1.5px solid #1e96ff; border-left:1.5px solid #1e96ff; }
        ...
        .img-fade {
          ...
          background:linear-gradient(to right,rgba(3,14,30,1) 0%,rgba(3,14,30,0.58) 32%,rgba(3,14,30,0.04) 100%);
          pointer-events:none;
        }
      `}</style>
      ...
      {/* Vignette */}
      <div style={{ position:"absolute", inset:0, background:"radial-gradient(ellipse 110% 100% at 50% 50%, transparent 35%, rgba(2,8,18,0.7) 100%)", pointerEvents:"none", zIndex:1 }}/>
            ...
            return (
              ...
              >
                ...
                <div style={{ display:"flex", alignItems:"center", gap:16, padding:isMobile?"16px":"0 22px", flex:1, height:"100%" }}>
                  <div style={{ width:44, height:44, flexShrink:0, border:`1px solid ${isHighlighted?"rgba(30,160,255,0.5)":"rgba(30,160,255,0.5)"}`, display:"flex", alignItems:"center", justifyContent:"center", background:isHighlighted?"rgba(30,140,255,0.1)":"rgba(30,140,255,0.1)", transition:"all 0.2s", clipPath:"polygon(0 0,calc(100% - 6px) 0,100% 6px,100% 100%,6px 100%,0 calc(100% - 6px))" }}>
                ...
                {/* Image */}
                <div style={{ width:isMobile?"100%":"clamp(190px,28%,100%)", height:isMobile?120:"100%", flexShrink:0, position:"relative", overflow:"hidden", borderLeft:isMobile?"none":"1px solid rgba(30,100,180,0.14)", borderTop:isMobile?"1px solid rgba(30,100,180,0.14)":"none" }}>
                  <img src={loc.image} alt={loc.city} className="loc-img" style={{ width:"100%", height:"100%", objectFit:"cover", filter:"brightness(0.48) saturate(0.38)", display:"block" }}/>
